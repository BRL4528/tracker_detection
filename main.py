...
# area1=[(480,1),(480,499),(520,499),(520,1)]
# area2=[(520,1),(520,499),(560,499),(560,1)]
...
#        print(row)
    ...
    for bbox in bbox_idx:
        x3, y3, x4, y4, id=bbox
        cv2.circle(frame, (x4, y4), 7, (255, 0, 0), -1)
    ...
    inc_c=(len(counter2))
    out_c=(len(counter1))
    cvzone.putTextRect(frame, f'IN_C:-{inc_c}', (50, 60), 2, 2)
    cvzone.putTextRect(frame, f'OUT_C:-{out_c}', (50, 160), 2, 2)
